...
function rollForTurn() {
    ...
    // determine and concatenate string showing which player won the rol
    if (pOne > pTwo) {
        first = "Player 1";
...
function avatarPlaced() {
    ...
    activePlayer = showPlayer.innerHTML; // get current player from the element
...
function check4Tie() {
    ...
    if(boardState.length >= 9 && check != "That's three in a row, Player 1 wins!" && check != "That's three in a row, Player 2 wins!") {
        var text1 = "Oh no! Nobody wins, it was a tie!";
...
function glowBoard(pos) {
    ...
    for (var i=0;i<squares.length;i++) {
        if (i == index0) {
            ...
            var bg3 = squars[i];
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(66,244,235)';}, 100);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(122,244,66)';}, 200);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(197,244,66)';}, 300);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(244,238,66)';}, 400);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(244,179,66)';}, 500);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(66,244,235)';}, 600);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(122,244,66)';}, 700);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(197,244,66)';}, 800);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(244,238,66)';}, 900);
            setTimeout(function() {bg3.style.backgroundColor = 'rgb(244,179,66)';}, 1000);
...
// ---------------------------------------------------------
// These functoins are algorithms to find all win conditions
// ---------------------------------------------------------
...
function checkWinCon2(info,squareArray) {
    ...
    // this will trigger (ONLY) if there was a match for index3, index4, index5
...
function checkWinCon3(info,squareArray) {
    ...
    // this will trigger (ONLY) if there was a match for index6, index7, index8
...
function checkWinCon4(info,squareArray) {
    ...
    // this will trigger (ONLY) if there was a match for index0, index3, index6
...
function checkWinCon5(info,squareArray) {
    ...
    // this will trigger (ONLY) if there was a match for index1, index4, index7
...
function checkWinCon6(info,squareArray) {
    ...
    // this will trigger (ONLY) if there was a match for index2, index5, index8
...
function checkWinCon7(info,squareArray) {
    ...
    // this will trigger (ONLY) if there was a match for index0, index4, index8
...
function checkWinCon8(info,squareArray) {
    ...
    // this will trigger (ONLY) if there was a match for index2, index4, index6
